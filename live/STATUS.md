# Status — 20 Aug 2026 17:16 EDT

Martin's Mac17,8, Logos **52.2.0.0019** ARM64.

**Now:** Logos PID **14227** (launched 17:10), ~955 MB, **dock Ethernet** `en7` 10.0.0.163 + Wi-Fi dual-path, **AC**. Last wake **16:16:29**. **No SIGSEGV.** No new Logos `.ips`/hang.
...
| **17:10:04** | **Relaunch** PID **14227** on dock Ethernet + Wi-Fi, AC. Idle ~6 min |

## Last EVENTS

```
17:05:40  SCAN  logos=not-running  ifaces=en7 en0
17:10:05  EVENT  logos started pid=14228
17:10:05  LOGOS.LOG  Starting application ... Pid: 14227
17:10:15  EVENT  logos pid changed 14228 -> 14227
17:10:40  SCAN  pid 14227 rss=1165MB threads=82  ifaces=en7 en0
17:15:41  SCAN  pid 14227 rss=955MB threads=80  ifaces=en7 en0
```

## Not a crash

No `addSessionReference` / SIGSEGV. 16:14, 16:20, and 16:45 exits were not crash-signed. 17:10 is a normal start.
