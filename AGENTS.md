...
- On this Linux desktop, open WhatsApp chats with `https://web.whatsapp.com/send?phone=...` rather than `wa.me` or `api.whatsapp.com` (those try to launch a missing desktop app and hit an "Open With" error).
- When asked to send WhatsApp, provide paste-ready drafts and filled-in `web.whatsapp.com/send` links; Hermes and OpenClaw have no WhatsApp channel.
- When asked to put mail in Gmail drafts, create the draft and do not send unless also asked to send.
- When explaining network issues to Martin, use Ethernet vs Wi-Fi (changing internet path), not mailbox metaphors.
